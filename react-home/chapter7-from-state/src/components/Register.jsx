  ...
  return (
    <div>
      <form>
        ...
        <p>Birth : <input type='date' name='birth' onChange={onMyChange}></input></p>
        <p>City :
        ...
        <p><input type="radio" name='gender' value='남성' onChange={onMyChange} /> Male &nbsp;&nbsp;
          <input type="radio" name='gender' value='여성' onChange={onMyChange} /> Female</p>
